...
-- Policy for startups to update their own compliance checks
...
-- Policy for CA/CS users to view all compliance checks
...
-- Policy for CA/CS users to update compliance checks
...
-- Policy for admins to view all compliance checks
...
-- Policy for startups to view their own uploads
...
-- Policy for startups to insert their own uploads
...
-- Policy for startups to delete their own uploads
...
-- Policy for CA/CS users to view all uploads
...
BEGIN
    ...
    -- Get country rules (this would need to be implemented based on your rules structure)
    -- For now, we'll create basic tasks
