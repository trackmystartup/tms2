-- Fix approval flow bugs - Clean version with proper function dropping
-- This script fixes all identified bugs in the approval flow

-- 1. Drop all existing approval functions with CASCADE to handle dependencies
...
-- 7. Add constraints to ensure data integrity (only if they don't exist)
DO $$ 
BEGIN
