-- Simple script to insert startup plans without ON CONFLICT
-- This avoids the unique constraint issue

-- =====================================================
-- STEP 1: DELETE EXISTING STARTUP PLANS (if any)
-- =====================================================

-- Remove any existing startup plans to avoid conflicts
DELETE FROM subscription_plans 
WHERE user_type = 'Startup';

-- =====================================================
-- STEP 2: INSERT STARTUP PLANS
-- =====================================================

-- Insert startup plans without ON CONFLICT
...
-- =====================================================
-- STEP 3: ADD BILLING_INTERVAL COLUMN FOR FUTURE USE
-- =====================================================
