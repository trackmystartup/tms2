-- Startup Subscription Plans Database Schema
...
BEGIN
    ...
    SELECT 
        ...
        sp.description,
        CASE 
            WHEN sp.interval = 'yearly' THEN 'Best Value - Save 2 months!'
            ELSE 'Flexible monthly billing'
        END as plan_benefit,
        CASE 
            WHEN sp.interval = 'yearly' THEN ROUND(sp.price / 12, 2)
            ELSE sp.price
        END as monthly_equivalent
