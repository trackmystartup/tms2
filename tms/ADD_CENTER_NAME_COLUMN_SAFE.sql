-- Add center_name column to users table (SAFE VERSION)
...
-- Step 6: Update RLS policies to include center_name (if they exist)
...
-- Step 8: Create a function to get facilitation center details by user email
...
-- Step 9: Create a view for easy access to facilitation center information
