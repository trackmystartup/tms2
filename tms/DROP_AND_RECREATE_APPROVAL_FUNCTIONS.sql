-- Drop and recreate approval functions for investment offers
-- This script handles the return type change properly
...
-- 2. Recreate function to approve/reject offers by investor advisor
...
-- 3. Recreate function to approve/reject offers by startup advisor
