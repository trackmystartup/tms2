-- Investment Advisor Database Setup
...
-- 16. Update existing RLS policies to include Investment Advisor role
...
-- Ensure users can insert their own profile (for registration)
...
-- Update startups table policies
...
-- 18. Create storage bucket for Investment Advisor documents
INSERT INTO storage.buckets (id, name, public) 
VALUES ('investment-advisor-documents', 'investment-advisor-documents', false)
ON CONFLICT (id) DO NOTHING;

-- 19. Create storage policies for Investment Advisor documents
...
-- 20. Create function to calculate scouting fees
...
-- 21. Create view for Investment Advisor dashboard metrics
...
-- 23. Create function to update relationship when user adds advisor code
...
-- 24. Create function to update startup relationship when startup adds advisor code
...
-- 25. Add Investment Advisor code field to registration forms (this would be handled in the frontend)
