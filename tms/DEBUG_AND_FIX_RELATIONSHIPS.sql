...
-- This script diagnoses the issue and fixes it step by step

-- 1. Check what startups actually have in their investment_advisor_code field
SELECT 
...
-- 2. Check what users have in their investment_advisor_code_entered field
SELECT 
...
-- 3. Check what Investment Advisors exist
SELECT 
...
-- 4. The issue: startups table has NULL codes, but users table has the codes
-- Let's copy the codes from users to startups
UPDATE startups 
...
-- 6. Now create the relationships
...
-- 7. Also create relationships for investors
...
-- 9. Show the actual relationships
SELECT 
